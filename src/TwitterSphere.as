package
{
	...
	public class TwitterSphere extends Sprite
	{
		...
		private var thankyouTicker:ThankyouScreen;
...
//			trace("TwitterSphere :: spotlight direction :: " + spotlight.sceneDirection);
//			var newDirection : Vector3D = new Vector3D(-camera.x, -camera.y, -camera.z);
//			newDirection.normalize();
//			newDirection = newDirection.add(new Vector3D(-1, 1, 1));
...
//			spotlight = new DirectionalLight();
//			spotlight.direction = new Vector3D(1, 0, 0);
...
//			spotlight.specular = .1;
		...
		private function onRowLoader() : void
		{
			...
			if(!twitter.tweets)
			{
				trace("TwitterSphere :: onRowLoader :: no tweets loaded");				
				return;
			}
